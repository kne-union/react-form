...
const fieldAddCreator = ({ formStateRef, initDataRef, setFormState, interceptors, emitter }) => ({ name, label, rule, interceptor, noTrim, value, index, groupName, groupIndex, fieldRef }) => {
